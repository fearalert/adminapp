...
import 'package:traveladminapp/controllers/chatcontroller.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final chatController =
        Get.put(ChatController('$adminId${userAuthentication.userID}'));
    return SafeArea(
      child: Scaffold(
                  ...
                  onTap: () async {
                    if (chatController.messageController.text.isNotEmpty) {
                      ...
                      FirebaseDatabase.instance
                          ...
                          .child('messages')
                          .child(
                              adminId! + {userAuthentication.userID}.toString())
                          .child(
                              dateTime + {userAuthentication.userID}.toString())
                          .set({
