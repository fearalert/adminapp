                    ...
                    children: <Widget>[
                      ...
                      Flexible(
                        child: TextField(
                          ...
                          onSubmitted: (value) {
                            controller.clear();
                            database.sendMessage(widget.userId, messageText, widget.packageId);
                          },
                          maxLines: null,
...
class MessagesStream extends StatelessWidget {
  final String packageId;
  final String userId;
  const  MessagesStream({Key?key, required this.packageId, required this.userId});
  @override
  Widget build(BuildContext context) {
  
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('messages').doc(userId).collection(packageId)
